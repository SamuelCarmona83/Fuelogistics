...
if [ $? -eq 0 ]; then
  ...
  curl -s "http://host.docker.internal:9000/api/issues/search?projectKeys=Prueba&resolved=false" -H "Authorization: Bearer sqp_e9b6b4171282a781dbb15dde8ace306aa6e57132" > sonar-issues.json
